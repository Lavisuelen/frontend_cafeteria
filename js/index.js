...
$("#cadastrar_cargo").addEventListener("click", function() {
  fecharNavBar();
  cargoController.renderizarCargoFormulario(componentePrincipal);
});

$("#lista_cargo").addEventListener("click", function() {
  fecharNavBar();
  cargoController.renderizarListaCargos(componentePrincipal);
});

$("#cadastrar_produto").addEventListener("click", function() {
  fecharNavBar();
  produtoController.renderizarProdutoFormulario(componentePrincipal);
});

$("#lista_produto").addEventListener("click", function() {
  fecharNavBar();
